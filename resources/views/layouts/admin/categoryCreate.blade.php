                ...
                <div class="panel-body h6">
                    ...
                    <form class="form-horizontal" role="form" method="POST" action="{{ action('CategoryController@store') }}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <p class="form-control-static">{{ $parent_name or 'Корневая' }}</p>
                            </div>
                        </div>
                        ...
                        <div class="form-group{{ $errors->has('name_cat') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="name_cat" type="text" class="form-control input-sm" name="name_cat" value="{{ old('name_cat') }}" required autofocus>
